...
{
    HitStruct rec;
    Sphere s({0,0,-10},1,std::make_shared<Lambert>(std::vector<vec3>{vec3({2.0,10.0,2.0})},color({0,0,0})));
    double tmax=1000;
...
TEST_CASE("Hit sphere from different perspective") {
    HitStruct rec;
    Sphere s({3,3,-3},1,std::make_shared<Lambert>(std::vector<vec3>{vec3({2.0,10.0,2.0})},color({0,0,0})));
    double tmax=1000;
...
TEST_CASE("Hit sphere at an angle from origin") {
    HitStruct rec;
    Sphere s({5,5,-5},1,std::make_shared<Lambert>(std::vector<vec3>{vec3({2.0,10.0,2.0})},color({0,0,0})));
    double tmax=1000;
