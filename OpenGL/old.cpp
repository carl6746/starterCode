...
int main(void)
{
    ...
    Robot robot(glm::vec3(0,0,10));
    Robot robot(glm::vec3(0,0,0));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 M_steve_parent = glm::translate(glm::mat4(1.0f), robot.getAnchor()) * glm::scale(glm::mat4(1.0f), glm::vec3(scale));
        ...
        for (int i = 0; i < robot.joints.size(); ++i) {
            glm::mat4 R = glm::mat4_cast(robot.joints[i].rotation);
            glm::mat4 T = glm::translate(glm::mat4(1.0f), glm::vec3(0, 0, robot.joints[i].length));
            ...
            glm::mat4 M_link = M_model * glm::translate(glm::mat4(1.0f), glm::vec3(0, 0, robot.joints[i].length * 0.5f)) * glm::scale(glm::mat4(1.0f), glm::vec3(thickness, thickness, robot.joints[i].length));
